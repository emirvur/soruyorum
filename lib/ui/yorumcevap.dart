...
class Yorumcevap extends StatefulWidget {
  final int x;
  final Cevapwithkull cvp;
  Yorumcevap({this.x, this.cvp});
  @override
  _YorumcevapState createState() => _YorumcevapState();
}

class _YorumcevapState extends State<Yorumcevap> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  TextEditingController cont;
  Future<List<Dtoyorum>> soruyorum(BuildContext context) async {
    print("yorumcevap api asaamsındada");

    List<Dtoyorum> lis = await APIServices.yorumcevappl(1);
    print(lis[0].yorum);
    print("bittiii");
    print(lis.toString());
          ...
          builder: (context, projectSnap) {
            ...
            return Column(
              children: [
                sorucard(
                    widget.cvp.cevaplar,
                    widget.cvp.cevaplayanid,
                    widget.cvp.cevaplayan,
                    widget.cvp.tarih,
                    widget.cvp.begenisayisi,
                    widget.cvp.dislikesayisi,
                    widget.cvp.mavitik,
                    context),
                Padding(
                  padding: const EdgeInsets.all(6.0),
                  child: Text(
                    "${widget.cvp.yorumsayisi} Yorum",
                ...
                SingleChildScrollView(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return yorumcard(project.ad, project.yorum, project.tarih,
                          project.userid, context);
                    },
                  ),
                ),
                Container(
                                  ...
                                  onTap: () async {
                                    if (_formKey.currentState.validate()) {
                                      ...
                                      int cid = context
                                          ...
                                          .kullaniciid;
                                      bool c =
                                          await APIServices.gonderyorumcevap(
                                              Yorum(
                                        0,
                                        cont.text,
                                        0,
...
Card sorucard(String cevaplar, int cvplynid, String cevaplayan, String tar,
    int begen, int disl, int mavitik, BuildContext context) {
  return Card(
      elevation: 10,
      child: Column(
        children: [
