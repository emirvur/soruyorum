...
class Feedui extends StatefulWidget {
  @override
  FeeduiState createState() => FeeduiState();
}

class FeeduiState extends State<Feedui> with AutomaticKeepAliveClientMixin {
  @override
  ...
  Future<List<Feeds>> list() async {
    ...
    List<Feeds> lis = await APIServices.feed(ku);
    print("kontrol222");
    print(lis.toString());
                          ...
                          children: <Widget>[
                            ListTile(
                              ...
                              title: project.soruid == -1
                                  ? project.cevapid == -1
                                      ? Text(
                                          "${project.takma} takip etmeye başladın")
                                      : Text("Cevap")
                                  : Text("Soru"),
