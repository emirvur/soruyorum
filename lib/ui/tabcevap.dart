...
class Tabcevap extends StatefulWidget {
  @override
  TabcevapState createState() => TabcevapState();
}

class TabcevapState extends State<Tabcevap> with AutomaticKeepAliveClientMixin {
  @override
  ...
  Future<List<Cevapwithkull>> list() async {
    ...
    List<Cevapwithkull> lis = await APIServices.cevapalkul(ku);
    print("kontrol222");
    print(lis.toString());
