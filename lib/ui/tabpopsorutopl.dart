...
class Tabpopsoru extends StatefulWidget {
  final int deger;

  Tabpopsoru({this.deger});
  @override
  TabpopsoruState createState() => TabpopsoruState();
}

class TabpopsoruState extends State<Tabpopsoru>
  ...
  Future<List<Soruwithkonu>> list() async {
    ...
    List<Soruwithkonu> lis = await APIServices.poptopluluksoru(widget.deger);
    print("kontrol222");
    print(lis.toString());
