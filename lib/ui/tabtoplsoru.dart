...
class Tabtoplsoru extends StatefulWidget {
  final int deger;

  Tabtoplsoru({this.deger});
  @override
  TabtoplsoruState createState() => TabtoplsoruState();
}

class TabtoplsoruState extends State<Tabtoplsoru>
  ...
  Future<List<Soruwithkonu>> list() async {
    print("kontrolll");
    List<Soruwithkonu> lis = await APIServices.topluluksoru(widget.deger);
    print("kontrol222");
    print(lis.toString());
